...
const mockProjects: Backend[] = [
  {
    ...
    description:
      "A fully featured e-commerce backend with authentication, product management, order processing, and payment integration.",
    language: "JavaScript",
    framework: "Express",
    apiType: "REST",
    author: "John Doe",
  ...
  },
  {
    ...
    description:
      "Modern social media backend with GraphQL, real-time notifications, and advanced caching strategies.",
    language: "Python",
    framework: "FastAPI",
    apiType: "GraphQL",
    author: "Jane Smith",
  ...
  const filteredProjects = useMemo(() => {
    return mockProjects.filter((project) => {
      ...
      const matchesFramework =
        !filters.framework || project.framework === filters.framework;
      const matchesApiType =
        !filters.apiType || project.apiType === filters.apiType;

      return (
        matchesSearch && matchesLanguage && matchesFramework && matchesApiType
      );
    });
  }, [searchQuery, filters]);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-grow">
        ...
        {view === "upload" && <UploadForm onBack={navigateToHome} />}
        {view === "docs" && <Documentation onBack={navigateToHome} />}
      </main>
